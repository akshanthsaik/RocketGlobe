...
import { formatDate, getStatusColor, formatCoordinates, getCountryFlag } from '../../../lib/utils';
    ...
    <div className="launch-detail-view">
      ...
      <div className="view-body">
        ...
        <div className="launch-header">
          ...
          {launch.status && (
            <span className={`status-chip large ${getStatusColor(launch.status)}`}>
              {launch.status}
            </span>
          )}
        </div>
          ...
          >
            <div className="info-card-header">
              ...
              <div className="info-card-content">
                ...
                <div className="info-card-title">{rocket.full_name || rocket.name}</div>
                {rocket.family && (
          ...
          >
            <div className="info-card-header">
              ...
              <div className="info-card-content">
                ...
                <div className="info-card-meta">
                  {agency.country_code && `${getCountryFlag(agency.country_code)} ${agency.country_code}`}
          ...
          >
            <div className="info-card-header">
              ...
              <div className="info-card-content">
                ...
                <div className="info-card-meta">
                  {pad.country_code && `${getCountryFlag(pad.country_code)} ${pad.country_code}`}
                  <br />
          ...
          <div className="detail-section">
            ...
            {launch.window_start && (
              <div className="detail-row">
                ...
                <span className="detail-value mono">{formatDate(launch.window_start)}</span>
              </div>
            )}
            {launch.window_end && (
              <div className="detail-row">
                <span className="detail-key">End:</span>
                <span className="detail-value mono">{formatDate(launch.window_end)}</span>
              </div>
            )}
          </div>
        )}
